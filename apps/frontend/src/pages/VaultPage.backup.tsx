...
import { encrypt, decrypt, decryptVaultKey } from '@/lib/crypto';
import { ArrowLeft, Plus, Search, Eye, EyeOff, Copy, Trash2, Key, FileText, CreditCard, Lock, RefreshCw, Unlock } from 'lucide-react';
